...
- Unify naming across Sections 03–06:
    * DEFAULT_USB_KEYS_PATH (Section 03) and DEFAULT_KEYS_USB_PATH (Section 04) -> both exported, same value
...
class TradingDefaults:
    session: SessionToggles = field(default_factory=SessionToggles)  # FIX: use default_factory
